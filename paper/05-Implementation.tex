...
\begin{aligned}
& \argmin_x f(x) + \alpha \sum \|\phi^*_i(\x)\|_2^2 \\
& \textrm{subject to} \\
& \phi_{d_i}(\x) = 0, \ \  i = 1, \ldots, m. \\ 
\end{aligned}
\end{equation}
...
\begin{equation}
f_\alpha(\x) = f(x) + \alpha \sum \|\phi^*_i(\x)\|_2^2
\end{equation}
