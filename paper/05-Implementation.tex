...
\begin{enumerate}
	...
	\item a line search method that backtracks if the resulting mesh does not exactly satisfy $\phi_{d_i}(\x) = 0, i = 1,...,m$.
\end{enumerate}
