...
Using the notation of  \figref{fig:fold_angle_and_tangent_angles}, we discretize the tangent of the crease curve at a given point by looking at the incident edge vectors $e_f, e_b$: 
