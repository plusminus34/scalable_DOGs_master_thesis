...
At \secref{sec:implementation} we show that under an isometric deformation and for a fixed dihedral angle, eq. \eqref{eq:tangents_dihedral} can be formalized as a linear constraint.
