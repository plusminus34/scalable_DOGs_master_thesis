...
Using the notation of figure \figref{fig:osc_plane_discretization}, we discretize the tangent of the crease curve as $t = \frac{\|e_b\|e_f + \|e_f\|e_b}{\|\|e_b\|e_f + \|e_f\|e_b\|}$, which for a creased curve is the tangent to the point at the unique circle passing through three points, and is linear in the vertices under isometry. 
%\begin{figure} [h]
%	\centering
%	\includegraphics[width=\linewidth]{figures/crease_tangent_notation}
%	\caption{Notation for the discretization of a crease curve tangent asthe tangent of the circle passing through }
%	\label{fig:crease_tangent_notation}
%\end{figure}