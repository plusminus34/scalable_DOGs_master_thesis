...
public:
	...
	OrthogonalGrid(const CGAL::Bbox_2& bbox2, int x_res, int y_res, const std::vector<Point_2>& additional_grid_points);
...
private:
	...
	void set_up_initial_grid(const CGAL::Bbox_2& bbox2, int x_res, int y_res);
