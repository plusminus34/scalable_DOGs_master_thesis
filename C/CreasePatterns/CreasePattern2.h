...
class CreasePattern2 {
  
public:
	CreasePattern2(const CGAL::Bbox_2& bbox, std::vector<Polyline_2> polylines, std::vector<Polyline_2> bnd_polylines,
							 int x_res, int y_res);
	CreasePattern2(const CreasePattern2& CreasePattern);
