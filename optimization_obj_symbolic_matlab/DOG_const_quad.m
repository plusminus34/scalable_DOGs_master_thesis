...
J_bnd_3_inner = [diff(E_12,p0_x),diff(E_12,p0_y),diff(E_12,p0_z)...
    diff(E_12,pxb_x),diff(E_12,pxb_y),diff(E_12,pxb_z)...
...
ccode(J_bnd_3_inner ,'file','DOG_const_quad_JacobianBnd3');
ccode(E_12,'file','DOG_quad_Constraints_vals_Bnd3');
