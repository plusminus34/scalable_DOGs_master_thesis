...
curve_fold_const = tanh(alpha*dot(e1,B)) + tanh(alpha*dot(e2,B));

%E = simplify(curve_fold_const.^2);
E = curve_fold_const.^2;
...
ccode(E ,'file','curved_fold_obj_binormal_sign_E');
ccode(gradient(E,vars),'file','curved_fold_obj_binormal_sign_G');
